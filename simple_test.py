...
def calculate_success_probability(Q: List[Relation], box_attributes: List[str],
    ...
    # Calculate AGM_W(Q)
    B = [(1, 100)] * len(
        box_attributes)  # Assuming attribute space is [1, 100]^d for simplicity
...
if __name__ == '__main__':
    ...
    print(count_oracle(R1, [(1, 5), (2, 6), (3, 7)],
                       box_attributes))  # Example usage of count_oracle
    print(count_oracle(R2, [(1, 5), (2, 6), (3, 7)],
                       box_attributes))  # Example usage of count_oracle
    print(median_oracle(Q, "B", [(1, 5), (2, 6), (3, 7)],
                        box_attributes))  # Example usage of median_oracle
